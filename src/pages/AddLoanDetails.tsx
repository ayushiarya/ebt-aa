...
const AddLoanDetails = () => {
  ...
  const { formData, setFormData } = useLoan();
  ...
  const handleSave = () => {
    setSubmitted(true);
    if (validate()) navigate("/loan-offer");
  };
  ...
  return (
    <div className="app-container min-h-screen flex flex-col bg-background page-enter">
      ...
      <div className="flex-1 overflow-y-auto px-5 pt-5 pb-28">
        ...
        <input
          type="text" placeholder="123456XXXX" value={formData.accountNumber}
        ...
        <div className="bg-accent/50 rounded-xl p-4 mb-5 flex gap-3">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            We verify your details with the provided documents. Any mismatch may require resubmission.
          </p>
        </div>
      ...
      <div className="sticky-cta">
        <button onClick={handleSave} disabled={!isFormFilled && !submitted} className="cta-primary">
          Save Details
        </button>
      </div>
    </div>
